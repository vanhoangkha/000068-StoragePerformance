...
4. In the **Stack name** interface
   ...
   - **Lab Modules**, select **Deploy S3 Security Lab** and **Deploy Storage Performance Lab** as **true**
   - Select **Next**
...
7. Wait about 10 minutes, Stack created successfully.

![CloudFormation Template](/images/2.1-LaunchCloudformation/0007.png?featherlight=false&width=90pc)

8. Viewing **Outputs** will have **PerformanceLabInstance** to use for this lab.
